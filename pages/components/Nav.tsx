  ...
  return (
    <nav className='w-full flex justify-between'>
        ...
        <div className="flex items-center justify-between">
            ...
            <div className={`${popUp} ${theme === 'dark' ? 'bg-grayscale-500 shadow-grayscale-400' : ''} shadow-lg group-hover:absolute top-16 mt-1 right-36 flex flex-col  pr-16 p-4 items-start gap-1 rounded-xl bg-grayscale-100`}>
