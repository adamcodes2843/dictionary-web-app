...
const NoDefinition = () => {
  return (
    <div className="w-full  flex flex-col justify-between items-center mt-28">
        ...
        <p className="text-center text-grayscale-400">Sorry pal, we couldn't find definitions for the word you were looking for. You can try the search again at a lter time or head to the web instead.</p>
    </div>
  )
}
