...
const SearchBar = ({handleChange, handleKeyDown, textInput, setWord, theme, word}) => {
  return (
    <div className={`${theme === 'dark' ? 'bg-grayscale-600' : 'bg-grayscale-200'} w-full rounded-2xl h-12 md:h-14 mt-4 md:mt-8 cursor-pointer hover:border-purplish focus-within:border-purplish focus-within:border-[1px] hover:border-[1px] focus:border-[1px] font-bold flex justify-between`}>
